...
if nm:
    ...
    u1 = st.number_input('January:', min_value = 0)
    u2 = st.number_input('Febuary:',min_value = 0)
    u3 = st.number_input('March:',min_value = 0)
    u4 = st.number_input('April:',min_value = 0)
    u5 = st.number_input('May:',min_value = 0)
    u6 = st.number_input('June:',min_value = 0)
    u7 = st.number_input('July:',min_value = 0)
    u8 = st.number_input('August:',min_value = 0)
    u9 = st.number_input('September:',min_value = 0)
    u10 = st.number_input('October:',min_value = 0)
    u11 = st.number_input('November:',min_value = 0)
    u12 = st.number_input('December:',min_value = 0)
