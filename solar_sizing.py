...
if nm:
    ...
    u1 = st.number_input('January:')
    u2 = st.number_input('Febuary:')
    u3 = st.number_input('March:')
    u4 = st.number_input('April:')
    u5 = st.number_input('May:')
    u6 = st.number_input('June:')
    u7 = st.number_input('July:')
    u8 = st.number_input('August:')
    u9 = st.number_input('September:')
    u10 = st.number_input('October:')
    u11 = st.number_input('November:')
    u12 = st.number_input('December:')
