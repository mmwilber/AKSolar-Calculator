...
if nm:
    ...
    u1 = st.number_input('January:', step = 1)
    u2 = st.number_input('Febuary:'step = 1)
    u3 = st.number_input('March:'step = 1)
    u4 = st.number_input('April:'step = 1)
    u5 = st.number_input('May:'step = 1)
    u6 = st.number_input('June:'step = 1)
    u7 = st.number_input('July:'step = 1)
    u8 = st.number_input('August:'step = 1)
    u9 = st.number_input('September:'step = 1)
    u10 = st.number_input('October:'step = 1)
    u11 = st.number_input('November:'step = 1)
    u12 = st.number_input('December:'step = 1)
